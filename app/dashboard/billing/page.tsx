    ...
    <div>
      ...
      <div className="sd-grid-3" style={{ marginBottom: 20 }}>
        ...
        <div className="sd-stat">
          ...
          <div className="sd-stat-value" style={{ fontSize: 18 }}>•••• 4242</div>
          <div className="sd-stat-sub">Visa · Verloopt 04/28</div>
        </div>
        <div className="sd-stat">
              ...
              <div className="sd-table-wrap">
                <table className="sd-table">
                  ...
                  <tbody>
                    {invoices.map(inv => (
                      <tr key={inv.id}>
                        <td style={{ fontWeight: 500, fontSize: 12 }}>{inv.id}</td>
                        <td style={{ color: "var(--s-muted)", fontSize: 12 }}>{inv.date}</td>
                        <td style={{ fontWeight: 600 }}>€{Number(inv.amount).toFixed(2)}</td>
                        <td><span className="sd-badge sd-badge-green">{inv.status}</span></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
