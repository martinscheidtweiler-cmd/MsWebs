      ...
      <div className="hi-detail-body">
        ...
        <div className="hi-detail-main">
              ...
              {[
                ...
                <div key={f.name} className="hi-facility-item">
                  ...
                  <span
                    ...
                    style={{
                      color: f.val === t.detail_yes ? "var(--orange)" : f.val === t.detail_no ? "var(--grey)" : "var(--warm-white)",
                      fontSize: f.val === t.detail_yes || f.val === t.detail_no ? 14 : undefined,
                    }}
                  >
                    {f.val}
                  </span>
          ...
          {property.features.length > 0 && (
            <div>
              <h3 className="hi-detail-section-title hi-r">{t.detail_features} & troeven</h3>
              <div
